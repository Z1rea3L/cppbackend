 ...
 */
TEST_F(ControllerWithTurnedOffTV, CantSelectChannel) {
    RunMenuCommand("SelectChannel 2"s);
    ExpectOutput("TV is turned off\n"sv);
}
TEST_F(ControllerWithTurnedOffTV, CantSelectPreviousChannel) {
 ...
 */
TEST_F(ControllerWithTurnedOnTV, SelectInvalidChannel) {
    RunMenuCommand("SelectChannel xyz"s);
    ExpectOutput("Invalid channel\n"sv);
}
TEST_F(ControllerWithTurnedOnTV, SelectChannel0) {
    RunMenuCommand("SelectChannel 0"s);
    ExpectOutput("Channel is out of range\n"sv);
}
TEST_F(ControllerWithTurnedOnTV, SelectChannel100) {
    RunMenuCommand("SelectChannel 100"s);
    ExpectOutput("Channel is out of range\n"sv);
}
TEST_F(ControllerWithTurnedOnTV, SelectChannel) {
