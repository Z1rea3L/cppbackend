...
boost::json::object JsonSerializer::MapSerialazer::Serialize(const model::Map& map) {
...
boost::json::array JsonSerializer::MapSerialazer::SerializeRoads(const std::vector<model::Road>& roads) {
...
boost::json::array JsonSerializer::MapSerialazer::SerializeBuildings(const std::vector<model::Building> buildings) {
...
boost::json::array JsonSerializer::MapSerialazer::SerializeOffices(const std::vector<model::Office> offices) {
